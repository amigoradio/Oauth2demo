...
- (void) uploadWeibo{
    if (accessToken && uid != 0) {
//        NSArray *array = [NSArray arrayWithObjects:@"abc",@"123",@"人民",@"456", nil];
...
- (void) uploadImageWeibo{
    if (accessToken) {
        ...
        ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:url];
        [request setPostValue:accessToken forKey:@"access_token"];
        [request setPostValue:@"111我上传的图片hahaha" forKey:@"status"];
